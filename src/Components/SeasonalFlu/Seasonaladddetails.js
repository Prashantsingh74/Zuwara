...
function Seasonaladddetails() {
    const navigate = useNavigate();
    const { IqamaPatientName, username, signupFormData } = useContext(Context);
    ...
    const { appointmentData, updateAppointmentData,userDetails } = useContext(Context);

    const [filteredResults, setFilteredResults] = useState([{
        Healthcare: appointmentData.Healthcare,
    ...
    const handleSearch = (event) => {
        ...
        if (term.trim() === '') {
            ...
            const healthcareName = appointmentData.Healthcare.toLowerCase();
    ...
    const handleSubmit = async () => {
        if (counter !== selectedPatients.length) {
            setError('The number of patients selected is not equal to selected test.');
        } else {
            setError('');
            ...
            // formData.append('Subservices', JSON.stringify(appointmentData.Subservices));
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    console.error('Error creating appointment:', result);
    ...
    try {
        ...
        subservicesText1 = subservices.map(service => service.label).join(', ');
    } catch (error) {
            ...
            <div className="add-details-72t" style={{ marginTop: "100px" }}>
                <div className="auto-group-dwhz-hqe">
                    ...
                    <div className="frame-37120-wfS">
                        <input type="text" className="poppins-regular zw_999999 zw_14" placeholder="Search your lab tests & Packages" value={searchTerm} onChange={handleSearch} style={{ width: "450px" }} />
                    ...
                    <div className="auto-group-k7dv-4Z2">
                        ...
                        <div className="auto-group-ck56-pRi mb-5">
                            ...
                            <div className='add-test pb-0'>
                                <p className="poppins-regular zw_16 zw_text_color">Choose one or more patients for this test</p>
                            ...
                            <div className="container">
                                <div className='row row-cols-1 row-cols-md-3 row-cols-lg-4' style={{ rowGap: '1rem' }}>
                                {userDetails.map((item, index) => (
                                    <div className="col" style={{ width: '23%' }} key={index}>
                                        <div
                                    ...
                                    {IqamaPatientName.map((pitem, index) => (
                                        <div className="col" style={{ width: '23%' }} key={index}>
                                            <div
                                                className={`patient-name poppins-regular zw_16 zw_text_color ${isPatientSelected(pitem) ? 'selected' : ''}`}
                        ...
                        <div className="auto-group-dsgg-mzU">
                            ...
                            <div className="group-1261154926-t7N">
                                ...
                                <label className='label-file' htmlFor="fileInput">
...
export default Seasonaladddetails;