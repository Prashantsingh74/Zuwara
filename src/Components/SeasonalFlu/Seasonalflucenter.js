                    ...
                    <div className="auto-group-f5yx-byE nusres-list-bdE">
                        ...
                        <div className="auto-group-nbnc-Es6">
                            ...
                            {filteredData.length === 0 ? (
                                <div >
                                    <p className="poppins-medium zw_18 zw_333333" style={{ padding: '20px' }}>No results found</p>
                                </div>
                            ) : (
...
export default Seasonalflucenter;