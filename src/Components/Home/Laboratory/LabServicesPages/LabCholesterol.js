...
function LabCholesterol() {
  ...
  const mostHelpData = [
    ...
    {
      Title: 'Health Check Packages for Men',
      Image: '../../images/diabities-img-anual.png'
    },
    {
      Title: 'Health Check Packages for women',
      Image: '../../images/diabities-img-anual.png'
    },
        ...
        <div className="laboratory-WM2">
          <div className='container'>
            <div className="auto-group-9h4y-a9r px-2">
              ...
              <div className='row gap-4 align-items-center py-5'>
                <div className='col-lg-3'>
                  <p className="lab-tests-packages-1Ac zw_32 zw_uppercase p-0 mt-2">Cholesterol</p>
                </div>
                <div class="col-lg-6">
