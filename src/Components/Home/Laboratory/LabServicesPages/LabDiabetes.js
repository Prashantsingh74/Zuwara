...
function LabDiabetes() {
  ...
  const mostHelpData = [
    {
      Title: 'Diabetes - Periodic test',
      Image: '../../images/diabetes-img.png'
    },
    {
      Title: 'Diabetes - Annually',
      Image: '../../images/diabities-img-anual.png'
    },
    {
      Title: 'Diabetes - Annuallya',
      Image: '../../images/diabities-img-anual.png'
    },
            ...
            <div className="auto-group-9h4y-a9r px-2">
              ...
              <div className='row align-items-center py-5'>
                <div className='col-lg-3'>
                  <p className="lab-tests-packages-1Ac zw_32 zw_uppercase p-0 mt-2">diabetes</p>
                </div>
                <div class="col-lg-6">
              ...
              <div className="auto-group-cncl-P6c">
                <div className="auto-group-ayeg-thS">
                  <div className="auto-group-9twz-df2">
                    <h1 className='zw_34 poppins-semibold zw_uppercase my-5'>packages</h1>
                    <div className='mt-4'>
