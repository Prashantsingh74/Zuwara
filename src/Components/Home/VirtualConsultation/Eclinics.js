        ...
        <div>
            ...
            <div className="nusres-list-u3z" style={{ marginTop: "60px" }}>
                <div className="group-1261155035-4Fe">
                    ...
                    <p className="poppins-semibold zw_30 zw_text_color">E-Clinics</p>
                ...
                <div className="auto-group-quuj-e44">
                    ...
                    <div className="auto-group-f5yx-byE nusres-list-bdE">
                        ...
                        <div className="auto-group-nbnc-Es6">
                                    ...
                                    <div className="group-1261155003-zbN" key={item.id}>
                                        ...
                                        <div className="time-slider-box">
                                            ...
                                            <div className="group-1261154689-Vvk">
                                                ...
                                                <div className='d-flex time-slot-select' style={{top: '-8rem'}}>
                            ...
                            <Link to="/Adddetails">
                                <button className="frame-37121-SnY poppins-regular" style={{ background: "linear-gradient(100.93deg, #af2245 0%, #602d8a 100%)", borderRadius: "0.5rem", color: "#ffffff", height: "5.3rem", width: "300px", border: "none", fontSize: "1.4rem" }}>Continue</button>
                            </Link>
                        </div>
                    </div>
                </div>
