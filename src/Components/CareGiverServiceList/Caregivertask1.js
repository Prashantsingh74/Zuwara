...
function Caregivertask1() {
    ...
    const caregiverTaskdata = [
        {
            image: require('../../assets/img/care_1.png'),
            title: 'Select caregiver task',
            subtitle: 'Assisting with daily tasks, keeping track of dietary needs, reminding of medication, accompanying the elderly to the hospital, taking care of you at home for 12 hours a day.',
            notehead: 'Includes',
        ...
        <div>
            ...
            <div className="container my-5">
                <div className="row gap-5 padd-x">
                    {
                        caregiverTaskdata.map((item, index) => (
                            <div className="col-lg-7" key={index}>
                                <div className="sa-info-light-bg sa-caregiver-helper">
                                    <div className="d-flex sel-caregiver-task">
                                        ...
                                        <p className='poppins-bold zw_24 zw_text_color ms-3 d-flex align-items-center'>{item.title}</p>
                                    </div>
